  ...
  return (
    <section className="py-8 sm:py-12 bg-white">
      <div className="container mx-auto px-4 sm:px-6">
        <div className="relative overflow-hidden rounded-2xl bg-brand-navy border border-slate-800 text-white shadow-md">
          <div className="relative z-10 grid grid-cols-1 lg:grid-cols-12 items-center gap-8 p-6 sm:p-10 lg:p-14">
            {/* Left Column: Copy & CTAs */}
            <div className="lg:col-span-7 flex flex-col items-start text-left">
              <div className="inline-flex items-center gap-2 rounded-full bg-teal-500/20 border border-teal-500/30 px-3.5 py-1.5 text-xs font-bold text-teal-300">
              ...
              <div className="mt-6 flex flex-wrap items-center gap-3">
                <div className="flex items-center gap-2 rounded-xl bg-white/10 px-4 py-2 text-xs font-mono font-bold tracking-wider backdrop-blur-md border border-white/15">
                  ...
                  <span>USE CODE:</span>
                  <span className="text-brand-orange font-black">ANYBUY50</span>
                </div>
              ...
              <div className="mt-8 flex items-center gap-4">
                <Link
                  href="#featured"
                  className="group inline-flex items-center gap-2.5 rounded-xl bg-brand-orange px-8 py-3.5 text-sm font-bold text-white shadow-sm transition-all duration-150 hover:bg-brand-orange-hover active:scale-98"
                >
