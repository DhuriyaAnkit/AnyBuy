    ...
    <div className="text-center py-4 space-y-6">
      {status === 'verifying' && (
        <div className="space-y-4 py-8">
          <Loader2 className="h-10 w-10 animate-spin text-brand-teal mx-auto" />
          <div>
              ...
              <form onSubmit={handleResend} className="space-y-3">
                ...
                <div className="relative flex items-center">
                  ...
                  <input
                    ...
                    className="w-full rounded-xl border border-[#E5E9ED] bg-white py-2.5 pl-10 pr-3.5 text-xs sm:text-sm text-brand-navy placeholder:text-[#8A95A3] focus:border-brand-teal focus:outline-none focus:ring-1 focus:ring-brand-teal/25"
                  />
                </div>
