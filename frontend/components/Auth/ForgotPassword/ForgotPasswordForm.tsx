    ...
    return (
      <div className="text-center py-4 space-y-4 animate-in fade-in zoom-in-95">
        ...
        <div className="pt-3">
          <Link
            href="/auth/sign-in"
            className="inline-flex items-center justify-center gap-2 w-full rounded-xl border border-brand-teal py-3 text-sm font-semibold text-brand-teal hover:bg-teal-50 transition-colors shadow-xs"
          >
    ...
    <div>
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <div className="text-center pt-3 border-t border-slate-100">
          <Link
            href="/auth/sign-in"
            className="inline-flex items-center gap-1.5 text-xs font-bold text-slate-600 hover:text-brand-teal transition-colors"
          >
